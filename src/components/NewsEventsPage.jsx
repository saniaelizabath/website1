...
const NewsEventsPage = ({ newsEvents }) => {
  return (
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h1 className="text-6xl font-bold text-white mb-4 tracking-tight">
            News & <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Events</span>
          </h1>
        ...
        {newsEvents.length > 0 ? (
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-slate-800/30 backdrop-blur-sm p-12 rounded-2xl border border-blue-500/20">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">No News or Events Yet</h3>
