...
const PortalPage = ({ setCurrentPage, setIsAdmin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 pt-32 pb-20 flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              {/* Description */}
              <p className="text-blue-200 text-center mb-6">
                Access your dashboard, documents, and resources
              </p>
