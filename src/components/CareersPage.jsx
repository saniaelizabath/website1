      ...
      <div className="relative z-10 pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 backdrop-blur-md border border-cyan-500/30 rounded-2xl p-8 shadow-xl">
          ...
          {careers.length > 0 ? (
            <div className="max-w-5xl mx-auto space-y-6">
              {careers.map((job) => (
                <div
                  key={job.id}
                  className="group bg-slate-800/60 backdrop-blur-md rounded-2xl border border-blue-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/30 overflow-hidden"
                >
                  <div className="p-8">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-slate-800/40 backdrop-blur-md p-12 rounded-2xl border border-blue-500/20 text-center shadow-xl">
                <svg
          ...
          <div className="max-w-5xl mx-auto mt-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-slate-800/40 backdrop-blur-md p-6 rounded-xl border border-blue-500/20 hover:border-cyan-500/50 transition-all duration-300 text-center group hover:scale-105 shadow-lg"
                >
                  <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-full flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
                    {benefit.icon}
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2">
                    {benefit.title}
